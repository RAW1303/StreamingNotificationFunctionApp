...
namespace Raw.Streaming.Discord
{
    ...
    internal static class AppSettings
    {
        ...
        public static string DiscordBotApplicationId { get; } = Environment.GetEnvironmentVariable("DiscordBotApplicationId");
        ...
        public static string DiscordGuildId { get; } = Environment.GetEnvironmentVariable("DiscordGuildId");
